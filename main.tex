...
\begin{itemize}
    ...
    \item \textbf{Move} a step left or right in the pipeline by pressing the
            \textbf{left} and \textbf{right} buttons
\end{itemize}
